...
SECRET_KEY = config('SECRET_KEY', default='your-production-secret-key-change-this')
...
# Database - Using SQLite for development (no PostgreSQL setup needed)
DATABASES = {
    'default': {
...
# JWT Settings
SIMPLE_JWT = {
    'ACCESS_TOKEN_LIFETIME': timedelta(days=7),  # Increased for development
